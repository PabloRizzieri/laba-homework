...
public class CerealProduct extends Product {
    private static final Logger LOGGER = LogManager.getLogger(CerealProduct.class);
    //Default constructor
    public CerealProduct(){}

    //New constructor using the inheritance to access the protected fields of Product
    public CerealProduct (String nameProduct, Integer productPrice, Integer productID, String productBranch, Boolean hasDiscount, Integer stock){
